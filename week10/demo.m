...
% Last Modified by GUIDE v2.5 20-Mar-2017 11:30:28
...
[fileName, pathName] = uigetfile({'*.jpg';'*.bmp'}, 'file select');
...
axes(handles.axes2); imshow(redi);
